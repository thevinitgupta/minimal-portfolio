  ...
  return (
    <div className='fixed bottom-0 right-0 z-20'>
      ...
      <div
        ...
        />
      {/* {isOpen && ( */}
      <div ref={chatRef} className={`fixed bottom-10 md:right-10 backdrop-blur  duration-200 border-b  bg-zinc-900/500 border border-zinc-600 p-4 rounded-lg shadow-md z-70 font-Mono`}>
