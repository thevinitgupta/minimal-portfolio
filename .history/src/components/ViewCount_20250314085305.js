...
export default function ViewCounter() {
    ...
    return (
        <div className="fixed top-4 right-4 bg-transparent w- text-zinc-400 border hover:border-zinc-400/50 border-zinc-600 px-4 py-2 rounded-full shadow-lg text-sm font-semibold">
