import { TbBrandReact, TbBrandFirebase, TbBrandMongodb, TbBrandFlutter, TbBrandNextjs, TbBrandTailwind } from 'react-icons/tb'
import { IoLogoNodejs } from 'react-icons/io'
import { SiSolidity, SiEthereum } from 'react-icons/si'
import { FaVuejs } from 'react-icons/fa'

export default function Card(data) {
    const {date, icons, title, description,slug, first=false} = data;
    const iconMap = {
        "react" : <TbBrandReact/>,
